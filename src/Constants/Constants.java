...
public class Constants {
    ...
    public static final String ASK_NAME = "Please enter the name: ";
    ...
    public static final String ASK_DISCHARGED_BOOK = "Is the book discharged?(Y/N) ";

    public static final String NO_COPIES_LEFT = "The book has no remaining copies";

    public static final String DELIVERED_BOOK = "The book has been successfully delivered!";

    public static final String NO_BOOK_FOUND = "The entered book was not found";
    ...
    public static String AUTHOR_ALREADY_AVAILABLE = "The author you want to make available is already available.";
